...
if __name__ == "__main__":
    ...
    if(args.verify):
        ...
        for npy_file in os.listdir(hp.integration.enroll_preprocessed_audio):
            print("\n")
            print("File : " + npy_file)
            print("- Precision : " + str(speaker_verify(hp.integration.enroll_preprocessed_audio + npy_file, speaker_to_test_path)))
    else :
        #enroll_audio_path = os.path.join(hp.integration.enroll_upload_folder, 'audio/')
        for wav_file in os.listdir(hp.integration.enroll_upload_audio_folder):
            #print(wav_file)
            speaker_enroll(hp.integration.enroll_upload_audio_folder + wav_file)
